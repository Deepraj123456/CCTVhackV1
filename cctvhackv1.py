...
Author: DEEPRAJ
GitHub: github.com/Deepraj123456
...
"""
    ...
    print(f"{Fore.GREEN}[*] Developed by: {Fore.YELLOW}DEEPRAJ{Style.RESET_ALL}")
    print(f"{Fore.GREEN}[*] GitHub: {Fore.YELLOW}github.com/Deepraj123456{Style.RESET_ALL}")
